...
public class Interfaz {
	...
	public static void main (String [] args) {
        ...
        case 1:
            ...
            vehiculo.s_cabina(JOptionPane.showInputDialog("Desea una cabina presurizada en su avioneta?"));
            vehiculo.s_superAceleracion(JOptionPane.showInputDialog("Desea una super aceleracion en su avioneta?"));
        ...
        case 2:
            ...
            vehiculo2.s_estabilizador(JOptionPane.showInputDialog("Desea un estabilizador en su Avion de Carga?"));
            vehiculo2.s_puertaDoble(JOptionPane.showInputDialog("Desea que su Avion de Carga tenga Doble Puerta para la descarga?"));
        ...
        case 3:
            ...
            vehiculo3.s_ventanasAntirruido(JOptionPane.showInputDialog("Desea Ventanas Antirruido en su Helicoptero?"));
            vehiculo3.s_doblehelice(JOptionPane.showInputDialog("Desea que su Helicoptero tenga Doble Helice?"));
        ...
        case 4:
            ...
            vehiculo4.s_doblepiso(JOptionPane.showInputDialog("Desea que su Avion de Pasajeros posea doble piso?"));
            vehiculo4.s_calentador(JOptionPane.showInputDialog("Desea tener calentadores para su Avion de Pasajeros?"));
